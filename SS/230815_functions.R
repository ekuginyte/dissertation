...
#         selected_predictors - selected predictor data frame with coefficients.
#
fit_crime_lasso <- function(data, nfolds = 10) {
...
#         selected_predictors - selected predictor data frame with coefficients.
#
fit_crime_elnet <- function(data, nfolds = 10) {
...
#
fit_crime_xgboost <- function(data, xgb_cv, xgb_grid) {
...
#
fit_crime_spikeslab_prior <- function(data, bigp_smalln, bigp_smalln_factor, seed = -42) {
...
#                        ever selected along the regularization path.
#         plot - A plot of the coefficient paths for the fitted model.
fit_crime_sslasso <- function(data, lambda1 = 1, lambda0 = seq(1, nrow(data),), 
