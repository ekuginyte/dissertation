...
# T3 data
ssp_T3_LD <- fit_spikeslab_cat_prior(data = T3_LD, cat_var = TRUE, bigp_smalln = FALSE)
ssp_T3_ED <- fit_spikeslab_cat_prior(data = T3_ED, cat_var = TRUE, bigp_smalln = FALSE)
ssp_T3_HD <- fit_spikeslab_cat_prior(data = T3_HD, cat_var = TRUE, 
                                     bigp_smalln = TRUE, 
                                     bigp_smalln_factor = 1, 
                                     screen = TRUE)
ssp_T3_VD <- fit_spikeslab_cat_prior(data = T3_VD, cat_var = TRUE, 
                                     bigp_smalln = TRUE, 
                                     bigp_smalln_factor = 1, 
                                     screen = TRUE)

# T4 data
ssp_T4_LD <- fit_spikeslab_cat_prior(data = T4_LD, cat_var = TRUE, bigp_smalln = FALSE)
ssp_T4_ED <- fit_spikeslab_cat_prior(data = T4_ED, cat_var = TRUE, bigp_smalln = FALSE)
ssp_T4_HD <- fit_spikeslab_cat_prior(data = T4_HD, cat_var = TRUE, 
                                     bigp_smalln = TRUE, 
                                     bigp_smalln_factor = 1, 
                                     screen = TRUE)
ssp_T4_VD <- fit_spikeslab_cat_prior(data = T4_VD, cat_var = TRUE, 
                                     bigp_smalln = TRUE, 
                                     bigp_smalln_factor = 1, 
                                     screen = TRUE)
...
# T3 Data
ssl_T3_LD <- fit_sslasso_cat(T3_LD, cat_var = TRUE)
ssl_T3_ED <- fit_sslasso_cat(T3_ED, cat_var = TRUE)
ssl_T3_HD <- fit_sslasso_cat(T3_HD, cat_var = TRUE)
ssl_T3_VD <- fit_sslasso_cat(T3_VD, cat_var = TRUE)

# T4 Data
ssl_T4_LD <- fit_sslasso_cat(T4_LD, cat_var = TRUE)
ssl_T4_ED <- fit_sslasso_cat(T4_ED, cat_var = TRUE)
ssl_T4_HD <- fit_sslasso_cat(T4_HD, cat_var = TRUE)
ssl_T4_VD <- fit_sslasso_cat(T4_VD, cat_var = TRUE)

# The output contains coefficients, ever_selected, and plot
#ssl_T1_LD$coefficients
#ssl_T4_HD$ever_selected
...
blasso_T3_HD <- fit_blasso_model(data = T3_VD, cat_var = TRUE)
blasso_T3_VD <- fit_blasso_model(data = T3_HD, cat_var = TRUE)

# T4 Data
blasso_T4_LD <- fit_blasso_model(data = T4_LD, cat_var = TRUE)
blasso_T4_ED <- fit_blasso_model(data = T4_ED, cat_var = TRUE)
blasso_T4_HD <- fit_blasso_model(data = T4_VD, cat_var = TRUE)
blasso_T4_VD <- fit_blasso_model(data = T4_HD, cat_var = TRUE)
